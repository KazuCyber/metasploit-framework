...
class MetasploitModule < Msf::Post
  ...
  def initialize(info = {})
    ...
    register_options(
      [
        ...
        OptBool.new('EXTRACT_CREDENTIALS', [false, 'Extract credentials and stores in a separate file', true]),
  ...
  def run
    ...
    print_status("EXTRACT_CREDENTIALS_FROM_FILE: #{datastore['EXTRACT_CREDENTIALS']}\n")
